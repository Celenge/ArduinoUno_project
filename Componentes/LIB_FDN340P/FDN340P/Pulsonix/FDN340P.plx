...
//974340/1064998/2.50/3/3/MOSFET P-Channel
...
(library Library_1
	...
	(symbolDef "FDN340P" (originalName "FDN340P")
	...
	(compDef "FDN340P" (originalName "FDN340P") (compHeader (numPins 3) (numParts 1) (refDesPrefix Q)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "FDN340P"))
		...
		(attr "Mouser Part Number" "512-FDN340P")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/onsemi-Fairchild/FDN340P?qs=AMp2PTjoga9dhzFXRaqTZw%3D%3D")
		(attr "Manufacturer_Name" "onsemi")
		(attr "Manufacturer_Part_Number" "FDN340P")
		(attr "Description" "Trans MOSFET P-CH 20V 2A 3-Pin SuperSOT")
		(attr "<Hyperlink>" "https://www.onsemi.com/pub/Collateral/FDN340P-D.PDF")
		(attr "<Component Height>" "1.12")
		(attr "<STEP Filename>" "FDN340P.stp")
